...
Gleichung wie $L[y]=g(x)$ durch: $L[y]=g(x); \quad y(a)=b_0, \quad y'(a)=b_1,
\dots, y^{n-1}(a)=b_{n-1}$, mit $b_i \in \mathbb{R}$.  Dieses
Anfangswertproblem hat eine eindeutige Lösung.
